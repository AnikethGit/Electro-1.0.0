...
define('SITE_URL', 'http://localhost/ecommerce/');  // Change in production
define('SITE_EMAIL', 'admin@electroshop.com');
...
define('MAIL_FROM', 'noreply@electroshop.com');
define('MAIL_FROM_NAME', 'ElectroShop');

// Admin Settings
define('ADMIN_EMAIL', 'admin@electroshop.com');
